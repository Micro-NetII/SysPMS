    ...
    classNames={{
      wrapper: "min-h-[222px]",
        ...
        <TableHeader>
            ...
            <TableColumn className="bg-primary-600 text-background font-bold flex justify-center items-center"><GoGear size={20}/></TableColumn>
        </TableHeader>
        <TableBody>
            <TableRow key="1">
            ...
            <TableRow key="7bg-primary-600 text-background font-bold">
                <TableCell>1</TableCell>
                <TableCell>1234</TableCell>
                <TableCell>Quarto Duplo</TableCell>
                <TableCell>QD</TableCell>
