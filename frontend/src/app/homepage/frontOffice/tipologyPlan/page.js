        ...
        <thead>
          <tr>
            ...
            {weeks[currentWeekIndex].map((day, index) => (
              ...
              ${day.date.isSame(today, 'day') ? "bg-red-500" : ""} select-none`}>
            ...
            <tr key={roomType.roomTypeID}>
              ...
              {weeks[currentWeekIndex].map((day, index) => {
                ...
                return (
                  <td
                    key={index}
                    className={`text-center border-l-3 border-r-3 border-b-2 rounded-lg ${day.date.day() === 0 || day.date.day() === 6 ? "bg-lightBlueCol" : "bg-white"
                      } ${selectionInfo.roomTypeID === roomType.roomTypeID && selectionInfo.dates.includes(day.date.format('YYYY-MM-DD')) ? "border-4 border-blue-400" : "border-tableCol"
                      } select-none`}
            ...
            {weeks[currentWeekIndex].map((day, index) => {
              ...
              return (
                <td
                  ...
                  ${dailyOccupancyPercentage <= 49 ? "bg-green" : ""} 
                  ${dailyOccupancyPercentage <= 69 ? "bg-yellow" : ""} 
                  ${dailyOccupancyPercentage <= 70 ? "bg-red" : ""} 
